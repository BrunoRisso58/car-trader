        ...
        <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" action="{{route('user.update', $user->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-center">
              <input id="image" name="image" type="file" accept=".jpeg, .jpg, .png" onchange="previewImage(event)" class="text-center">
            </div>
            @error('image')
      ...
      function previewImage(event) {
          ...
          if (input.files && input.files[0]) {
              ...
              reader.onload = function (e) {
                  ...
                  img.classList.add('mx-auto', 'h-44', 'w-44', 'object-cover', 'text-gray-300', 'm-4', 'rounded-full');
